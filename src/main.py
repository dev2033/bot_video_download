...
class TikTokDownloader:
    ...
    def _get_video_url(self) -> str:
        ...
        return response.text.split('"playAddr":"')[1].split('"')[0].replace(
            r'\u0026', '&')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--web-id',
                        help='Value of tt_webid or tt_webid_v2 cookie (they are the same).')
    parser.add_argument('-o', '--output', default='download.mp4',
                        help='Full output path.')
    parser.add_argument('url',
                        help='Video url (https://www.tiktok.com/@username/video/1234567890123456789 or https://vm.tiktok.com/a1b2c3/).')
